package com.micro.old.server.client;
 ...
 * @Description: * feign与@RequestParam配合使用时，一定要写value值。
...
public interface AccountFeignClient {
	...
	public GlobeResponse<Object> getUserMoney(@RequestParam("userName") String userName,
